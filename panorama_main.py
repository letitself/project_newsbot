...
opb_token = '1034547759:AAFaTnbbXro8Q_WdU2lvn2zksjburRvW9Pg'    #Oleg_Panorama_Bot
...
def get_text_messages(message):
    if message.text == '/random_article':
        ...
        ax.axis("equal")
        plt.savefig('C:/Users/asada/Documents/ФИКЛ/программирование/проектк/haha.png')
        with open('C:/Users/asada/Documents/ФИКЛ/программирование/проектк/haha.png', 'rb') as photo:
